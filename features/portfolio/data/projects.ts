...
seed locking, and auto-generated BYEs.
- **Successfully deployed** to production at UIT Taekwondo Tournaments, serving live match operations
across multiple arenas with positive feedback from organizers and athletes.
`,
...
- Supports manual and voice notes, daily streak tracking, copy format presets (Slack, Jira, Notion), and a weekly activity summary by work type.
`,
    logo: `${baseUrl}/standup-log.webp`,
  },
];
